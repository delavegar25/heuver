      ...
      <main className='mx-auto px-4 sm:mt-24 bg-hero mb-52 overflow-hidden'>
        ...
        <div className='text-center'>
          ...
          <p className='mt-3 max-w-md mx-auto text-base dark:text-white sm:text-lg md:mt-5 md:text-xl md:max-w-3xl'>
            Heuvera aggregates the best hotels, apartments, and properties that
          ...
          <div className='mt-8'>
            ...
            >
              <ArrowCircleDownIcon className='h-6 w-6 text-purple dark:text-lighterPurple' />
            </motion.div>
            <p className='dark:text-white'>
              Press "Y" on your keyboard to Explore
            </p>
          </div>
        </div>
      </main>
